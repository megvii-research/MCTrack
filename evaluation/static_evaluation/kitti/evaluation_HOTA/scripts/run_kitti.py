...
Command Line Arguments: Defaults, # Comments
    ...
    Dataset arguments:
        ...
        'SPLIT_TO_EVAL': 'train',  # Valid: 'train', 'val', 'training_minus_val', 'test'
...
def eval_kitti(cfg):
    ...
    default_dataset_config = trackeval.datasets.Kitti2DBox.get_default_dataset_config(cfg)
    ...
    # Run code
    evaluator = trackeval.Evaluator(eval_config, cfg)
    dataset_list = [trackeval.datasets.Kitti2DBox(dataset_config, cfg)]
    metrics_list = []
